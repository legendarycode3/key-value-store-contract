...
* ****Associative State Tracking:**** They are crucial for assigning balances or ownership to specific addresses. For example, a KVS matches a user's wallet address (the key)
