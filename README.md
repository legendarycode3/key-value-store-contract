...
* ****Decentralized Finance (DeFi) Allowances:**** Records wallet addresses (keys) and the specific token amounts or spending allowances (values) they are permitted to trade
